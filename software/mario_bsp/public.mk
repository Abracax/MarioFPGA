...
# setting SOPC_SYSID_BASE_ADDRESS is 0x128
SOPC_SYSID_FLAG += --sidp=0x128
ELF_PATCH_FLAG  += --sidp 0x128

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1599667845
SOPC_SYSID_FLAG += --timestamp=1599667845
ELF_PATCH_FLAG  += --timestamp 1599667845
